#!/usr/bin/env python
"""Solves part 2 of the day 24 puzzle of the 2022 Advent of Code challenge."""
...
def main():
    ...
    answer1 = find_shortest(((0, 1), 0), (row_count - 1, col_count - 2), vertices, neighbors)
    # print(answer1)
    answer2 = find_shortest(((row_count - 1, col_count - 2), answer1), (0, 1), vertices, neighbors)
    # print(answer2)
    answer = find_shortest(((0, 1), answer2), (row_count - 1, col_count - 2), vertices, neighbors)
